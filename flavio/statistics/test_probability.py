...
class TestProbability(unittest.TestCase):
    ...
    def test_convolute_normal(self):
    ...
    def test_convolute_numerical(self):
        from flavio.statistics.probability import _convolute_numerical
        ...
        conv_p_12 = _convolute_numerical([p_1, p_2])
        comb_p_12 = NormalDistribution(12.4, sqrt(0.346**2 + 2.463**2))
        conv_p_123 = _convolute_numerical([p_1, p_2, p_3])
