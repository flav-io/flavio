...
observables_p = {
    'SP1': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: S_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, 3) / 2, 'tex': r'_{S}P_{1}', 
    ...
    'SP2': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: S_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, '6s') / 8, 'tex': r'_{S}P_{2}', 
    'desc': 'CP-averaged optimised time-integrated angular observable. ', 
    'func_den': lambda y, x, gamma, J, J_bar, J_h, J_s: S_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, '2s')},
    'SP3': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: -S_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, 9) / 4, 'tex': r'_{S}P_{3}', 
    'desc': 'CP-averaged optimised time-integrated angular observable. ', 
    'func_den': lambda y, x, gamma, J, J_bar, J_h, J_s: S_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, '2s')},
    'SS': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: S_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, '6c'), 'tex': r'_{S}S', 
    'desc': 'CP-averaged optimised time-integrated angular observable. ', 
    'func_den': lambda y, x, gamma, J, J_bar, J_h, J_s: S_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, '2s')},
    'AP1': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: A_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, 3) / 2, 'tex': r'_{A}P_{1}', 
    'desc': 'CP-asymmetric optimised time-integrated angular observable. ', 
    'func_den': lambda y, x, gamma, J, J_bar, J_h, J_s: S_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, '2s')},
    'AP2': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: A_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, '6s') / 8, 'tex': r'_{A}P_{2}', 
    'desc': 'CP-asymmetric optimised time-integrated angular observable. ', 
    'func_den': lambda y, x, gamma, J, J_bar, J_h, J_s: S_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, '2s')},
    'AP3': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: -A_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, 9) / 4, 'tex': r'_{A}P_{3}', 
    'desc': 'CP-asymmetric optimised time-integrated angular observable. ', 
    'func_den': lambda y, x, gamma, J, J_bar, J_h, J_s: S_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, '2s')},
    'AS': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: A_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, '6c'), 'tex': r'_{A}S', 
    'desc': 'CP-asymmetric optimised time-integrated angular observable. ', 
    'func_den': lambda y, x, gamma, J, J_bar, J_h, J_s: S_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, '2s')},
    ...
    'desc': 'CP-averaged optimised angular observable. ', 
    'func_den': lambda y, x, gamma, J, J_bar, J_h, J_s: K_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, '2s')},
    'WP1': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: W_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, 3) / 2, 'tex': r'_{W}P_{1}', 
    'desc': 'CP-asymmetric optimised angular observable. ', 
    'func_den': lambda y, x, gamma, J, J_bar, J_h, J_s: K_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, '2s')},
    'WP2': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: W_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, '6s') / 8, 'tex': r'_{W}P_{2}', 
    'desc': 'CP-asymmetric optimised angular observable. ', 
    'func_den': lambda y, x, gamma, J, J_bar, J_h, J_s: K_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, '2s')},
    'WP3': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: -W_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, 9) / 4, 'tex': r'_{W}P_{3}', 
    'desc': 'CP-asymmetric optimised angular observable. ', 
    'func_den': lambda y, x, gamma, J, J_bar, J_h, J_s: K_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, '2s')},
    'WS': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: W_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, '6c'), 'tex': r'_{W}S', 
    'desc': 'CP-asymmetric optimised angular observable. ', 
    'func_den': lambda y, x, gamma, J, J_bar, J_h, J_s: K_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, '2s')},
}
observables_pprime = {
    'SP4p': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: S_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, 4), 'tex': r'_{S}P_{4}^\prime', 
    'desc': 'CP-averaged optimised time-integrated angular observable. ', 'func_den': S_experiment_num_Bs},
    'SP5p': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: 0.5 * S_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, 5), 'tex': r'_{S}P_{5}^\prime', 
    'desc': 'CP-averaged optimised time-integrated angular observable. ', 'func_den': S_experiment_num_Bs},
    'SP6p': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: -0.5 * S_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, 7), 'tex': r'_{S}P_{6}^\prime', 
    'desc': 'CP-averaged optimised time-integrated angular observable. ', 'func_den': S_experiment_num_Bs},
    'SP8p': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: S_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, 8), 'tex': r'_{S}P_{8}^\prime', 
    'desc': 'CP-averaged optimised time-integrated angular observable. ', 'func_den': S_experiment_num_Bs},
    'AP4p': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: A_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, 4), 'tex': r'_{A}P_{4}^\prime', 
    'desc': 'CP-asymmetric optimised time-integrated angular observable. ', 'func_den': S_experiment_num_Bs},
    'AP5p': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: 0.5 * A_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, 5), 'tex': r'_{A}P_{5}^\prime', 
    'desc': 'CP-asymmetric optimised time-integrated angular observable. ', 'func_den': S_experiment_num_Bs},
    'AP6p': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: -0.5 * A_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, 7), 'tex': r'_{A}P_{6}^\prime', 
    'desc': 'CP-asymmetric optimised time-integrated angular observable. ', 'func_den': S_experiment_num_Bs},
    'AP8p': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: A_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, 8), 'tex': r'_{A}P_{8}^\prime', 
    'desc': 'CP-asymmetric optimised time-integrated angular observable. ', 'func_den': S_experiment_num_Bs},
    ...
    'desc': 'CP-averaged optimised angular observable. ', 'func_den': K_experiment_num_Bs},
    'WP4p': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: W_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, 4), 'tex': r'_{W}P_{4}^\prime', 
    'desc': 'CP-asymmetric optimised angular observable. ', 'func_den': K_experiment_num_Bs},
    'WP5p': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: 0.5 * W_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, 5), 'tex': r'_{W}P_{5}^\prime', 
    'desc': 'CP-asymmetric optimised angular observable. ', 'func_den': K_experiment_num_Bs},
    'WP6p': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: -0.5 * W_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, 7), 'tex': r'_{W}P_{6}^\prime', 
    'desc': 'CP-asymmetric optimised angular observable. ', 'func_den': K_experiment_num_Bs},
    'WP8p': {'func_num': lambda y, x, gamma, J, J_bar, J_h, J_s: W_experiment_num_Bs(y, x, gamma, J, J_bar, J_h, J_s, 8), 'tex': r'_{W}P_{8}^\prime', 
    'desc': 'CP-asymmetric optimised angular observable. ', 'func_den': K_experiment_num_Bs},
