...
class TestDPFF(unittest.TestCase):
    def test_etm(self):
        ...
        self.assertAlmostEqual(ff_pi_max['f+'], 2.130, delta=0.01)
        self.assertAlmostEqual(ff_pi_0['fT'], 0.506, delta=0.001)
        self.assertAlmostEqual(ff_pi_max['fT'], 1.573, delta=0.01)
